...
fn main() -> ! {
    ...
    let mut led = RgbLed::new(
        gpio::Output::new(p.PI12, gpio::Level::High, gpio::Speed::Low),
        gpio::Output::new(p.PJ13, gpio::Level::High, gpio::Speed::Low),
        gpio::Output::new(p.PE3, gpio::Level::High, gpio::Speed::Low),
    )
    .unwrap();
