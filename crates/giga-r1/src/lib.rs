...
//!
//! Hardware families are opt-in through the `audio`, `camera`, `can`,
//! `display`, `dual-core`, `qspi`, `sdcard`, `usb`, and `wifi` features.
//! Logging support is independently enabled with `defmt`.
//!
//! See the
